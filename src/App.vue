<script setup lang="ts">
  ...
  import { useStorePost } from './stores/store-post';
...
<template>
  ...
  ></div>
  <div class="mx-auto grid max-w-[800px] gap-14 p-8 sm:grid-cols-[1fr_1.1fr]">
    <PostsList
      element="main"
...
<style lang="scss">
  html {
    @apply bg-neutral-100 text-neutral-600 font-sans;
  }
</style>
